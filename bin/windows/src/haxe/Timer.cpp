...
HX_DEFINE_STACK_FRAME(_hx_pos_a507cc4491813d5d_76_new,"haxe.Timer","new",0x4136b0cf,"haxe.Timer.new","C:\\HaxeToolkit\\haxe\\std/haxe/Timer.hx",76,0xfc3a7709)
HX_DEFINE_STACK_FRAME(_hx_pos_a507cc4491813d5d_65_new,"haxe.Timer","new",0x4136b0cf,"haxe.Timer.new","C:\\HaxeToolkit\\haxe\\std/haxe/Timer.hx",65,0xfc3a7709)
HX_LOCAL_STACK_FRAME(_hx_pos_a507cc4491813d5d_106_stop,"haxe.Timer","stop",0xd1fd70b3,"haxe.Timer.stop","C:\\HaxeToolkit\\haxe\\std/haxe/Timer.hx",106,0xfc3a7709)
HX_LOCAL_STACK_FRAME(_hx_pos_a507cc4491813d5d_129___default_run,"haxe.Timer","__default_run",0xdc2b9b9c,"haxe.Timer.__default_run","C:\\HaxeToolkit\\haxe\\std/haxe/Timer.hx",129,0xfc3a7709)
HX_LOCAL_STACK_FRAME(_hx_pos_a507cc4491813d5d_142_delay,"haxe.Timer","delay",0x3ed5f1b2,"haxe.Timer.delay","C:\\HaxeToolkit\\haxe\\std/haxe/Timer.hx",142,0xfc3a7709)
HX_LOCAL_STACK_FRAME(_hx_pos_a507cc4491813d5d_140_delay,"haxe.Timer","delay",0x3ed5f1b2,"haxe.Timer.delay","C:\\HaxeToolkit\\haxe\\std/haxe/Timer.hx",140,0xfc3a7709)
namespace haxe{

void Timer_obj::__construct(int time_ms){
            		HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::haxe::Timer,_gthis) HXARGC(0)
            		void _hx_run(){
            			HX_STACKFRAME(&_hx_pos_a507cc4491813d5d_76_new)
HXLINE(  76)			_gthis->run();
            		}
            		HX_END_LOCAL_FUNC0((void))

            	HX_STACKFRAME(&_hx_pos_a507cc4491813d5d_65_new)
...
void Timer_obj::stop(){
            	HX_STACKFRAME(&_hx_pos_a507cc4491813d5d_106_stop)
...
void _hx_run(){
            	HX_STACKFRAME(&_hx_pos_a507cc4491813d5d_129___default_run)
            	}
HX_END_LOCAL_FUNC0((void))
HX_END_DEFAULT_FUNC
 ...
 ::haxe::Timer Timer_obj::delay( ::Dynamic f,int time_ms){
            		...
            		void _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_a507cc4491813d5d_142_delay)
HXLINE( 143)			t->stop();
HXLINE( 144)			f();
            		}
            		HX_END_LOCAL_FUNC0((void))

            	HX_GC_STACKFRAME(&_hx_pos_a507cc4491813d5d_140_delay)
