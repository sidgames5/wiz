...
namespace haxe.lang {
	public sealed class FieldLookup {
		...
		protected static int[] fieldIds = new int[]{98, 109, 1821933, 4745537, 4949376, 5144726, 5393365, 5442204, 5594513, 5594516, 5741474, 5744817, 5843823, 25738091, 46374763, 52644165, 57476627, 68006728, 76061764, 78945784, 87367608, 132916898, 133414859, 142301684, 157772329, 159136996, 208459108, 221637784, 243225909, 288167040, 302979532, 312752480, 328878574, 359333139, 407283053, 426240764, 437335495, 452737314, 480756972, 493819893, 501039929, 520590566, 537630174, 572311959, 610723709, 630156697, 640252688, 652994848, 701410669, 746281503, 756413782, 834174833, 863972113, 922671056, 946786476, 995006396, 1058556349, 1067353468, 1103412149, 1126037278, 1126920507, 1177754921, 1181037546, 1204816148, 1214453688, 1224901875, 1228056441, 1238832007, 1247875546, 1257164128, 1271070480, 1273207865, 1280549057, 1280845662, 1282943179, 1313416818, 1352786672, 1381630732, 1395555037, 1398464674, 1431819701, 1436822557, 1450762973, 1460447810, 1512997393, 1532710347, 1537812987, 1547539107, 1620824029, 1621420777, 1623148745, 1639293562, 1643404487, 1648581351, 1661489734, 1693277929, 1705629508, 1723805383, 1763375486, 1768617329, 1825849507, 1830310359, 1836776262, 1887596712, 1915412854, 1916009602, 1937159360, 1981972957, 1987394228, 2022294396, 2025055113, 2048392659, 2054707467, 2082663554, 2113708439, 2127021138};
		
		protected static string[] fields = new string[]{"b", "m", "isGlobal", "__a", "cur", "get", "len", "map", "pop", "pos", "set", "str", "url", "exitCode", "readAll", "match", "getEnumConstructs", "stdin", "remove", "__previousException", "filter", "stderr", "stdout", "resize", "onError", "matched", "parseString", "__nativeException", "readBytes", "stream", "methodName", "get_native", "iterator", "lastIndexOf", "hasNext", "formatted", "message", "reverse", "nOccupied", "getBytes", "insert", "length", "get_message", "native", "writeFullBytes", "array", "writeString", "invalidNumber", "invalidChar", "contains", "emptyOnData", "value", "__nativeStack", "cachedIndex", "toString", "hashes", "_eof", "splice", "copy", "exit", "matchSub", "__skipStack", "join", "concat", "close", "next", "enumConstructor", "writeByte", "push", "keyValueIterator", "matchedPos", "current", "size", "sort", "quicksort", "vals", "spliceVoid", "writeBytes", "cachedKey", "getEnumName", "createEnumIndex", "createEnum", "parseRec", "__ownStack", "posInfos", "concatNative", "nBuckets", "className", "__unsafe_get", "__unsafe_set", "indexOf", "lookup", "downloadUrl", "fileName", "headers", "onData", "toDynamic", "regex", "readByte", "allEnums", "unwrap", "customParams", "params", "doParse", "__get", "__set", "__hx_deleteField", "lineNumber", "cnxTimeout", "upperBound", "unshift", "_keys", "enumParameters", "shift", "addChar", "slice"};
